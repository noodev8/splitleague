/*
API service for resetting a league by deleting all fixtures
Allows league organizers to reset the league to its initial state
*/
...
class ResetLeagueFixturesApi {
  // Reset a league by deleting all fixtures
  static Future<Map<String, dynamic>> resetLeagueFixtures(int leagueId) async {
    // Create the request URL
    final url = Uri.parse('${Config.baseUrl}/reset_league_fixtures');
