/*
API service for resetting all scores in a league
Allows league organizers to reset all fixture scores
*/
...
class ResetLeagueScoresApi {
  // Reset all scores for a league
  static Future<Map<String, dynamic>> resetLeagueScores(int leagueId) async {
    // Create the request URL
    final url = Uri.parse('${Config.baseUrl}/reset_league_scores');
