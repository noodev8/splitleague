                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (_standings.isNotEmpty && _standings.first.containsKey('score_for')) ...[
                        const SizedBox(width: 30, child: Text('F', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center)),
                        const SizedBox(width: 30, child: Text('A', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center)),
                        const SizedBox(width: 30, child: Text('+/-', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center)),
                      ],
                      const SizedBox(width: 8),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              FutureBuilder<String>(
                                future: _getOrganizerNickname(_leagueInfo['created_by']),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                _formatDate(_leagueInfo['start_date']),
                                style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                ),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                _formatDate(_leagueInfo['end_date']),
                                style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                ),
