/*
Show only the fixtures for a league without tabs
This is a simplified version of the fixtures screen that only shows fixtures
*/
...
import 'standings_only_screen.dart';
import 'details_only_screen.dart';

class FixturesOnlyScreen extends StatefulWidget {
  final Map<String, dynamic> league;

  const FixturesOnlyScreen({
    super.key,
    required this.league,
  });

  @override
  State<FixturesOnlyScreen> createState() => _FixturesOnlyScreenState();
}

class _FixturesOnlyScreenState extends State<FixturesOnlyScreen> {
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => StandingsOnlyScreen(
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => DetailsOnlyScreen(
                                  league: widget.league,
                                ),
                              ),
                            );
